...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        status_bt=(Button)findViewById(R.id.bt_status);

        status_bt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(status_bt.getText()=="ON"){
                    Flag=0;
                    status=0;
                    status_bt.setText("OFF");
                    register(lat,lnng,status);
...
//        Toast.makeText(MapsActivity.this,"Your Current Location", Toast.LENGTH_LONG).show();
    ...
    private void displayLocation() {
        ...
        if (mLastLocation != null) {
            ...
            Toast.makeText(mContext,"Couldn't get the location. Make sure location is enabled on the device",Toast.LENGTH_SHORT).show();
    ...
    private void register(final Double lat, final Double lnng, final int stt) {
...
//                Toast.makeText(getApplicationContext(),s,Toast.LENGTH_LONG).show();
            ...
            protected String doInBackground(String... params) {
                ...
                data.put("status",String.valueOf(stt));
